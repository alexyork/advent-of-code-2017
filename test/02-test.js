...
import { getSpreadsheetChecksum, getSpreadsheetChecksum2 } from '../src/02.js';
...
*/
describe('AoC 02-01 - Checksum puzzle', () => {

    it('should produce a checksum of 18 for the example input', () => {
        const spreadsheetInput = `
            5,1,9,5
            7,5,3
            2,4,6,8
        `;
        const result = getSpreadsheetChecksum(spreadsheetInput);
        expect(result).to.equal(18);
    });

    it('should produce a checksum of X for the input X', () => {
        const spreadsheetInput = `
...
describe('AoC 02-02 - Checksum puzzle', () => {
    ...
    it('should produce a checksum of 18 for the example input', () => {
        const spreadsheetInput = `
            ...
            3,8,6,5
        `;
        const result = getSpreadsheetChecksum2(spreadsheetInput);
